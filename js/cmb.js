    ...
    window.send_to_editor = function (html) {
		...
		if (formfield) {
			...
			if (itemurl.match(image)) {
				uploadStatus = '<div class="img_status"><img src="../../Copy of simple-vacation/js/' + itemurl + '" alt="" /><a href="#" class="cmb_remove_file_button" rel="' + formfield + '">Remove Image</a></div>';
			} else {
				// No output preview if it's not an image
				// Standard generic output if it's not an image.
				html = '<a href="../../Copy of simple-vacation/js/' + itemurl + '" target="_blank" rel="external">View File</a>';
